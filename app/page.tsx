                  ...
                  <div className="relative z-10 h-full flex items-center text-white pt-16 pb-20 md:pt-4 md:pb-24">
                    <div className="container mx-auto px-4 lg:px-8">
                      <div className="max-w-6xl mx-auto text-center space-y-6">
                        {/* Welcome Message */}
                        <p className="text-3xl md:text-5xl lg:text-6xl text-white/90 font-medium drop-shadow-md leading-tight">
                          Bienvenue sur la plateforme d'E-Learning de 
                          <span className="block text-primary">Orange</span>{" "}
        ...
        <div className="container mx-auto px-4 sm:px-6 lg:px-8">
          <FadeInView delay={0.1}>
            <div className="text-center mb-8 lg:mb-12">
              <h2 className="text-2xl sm:text-3xl lg:text-4xl font-bold text-primary mb-4 tracking-tight" style={{ color: 'var(--primary)' }}>
